...
DIANE can be used at https://diane.ipsim.inrae.fr, or locally installed.
...
Gene lists do not have to come from a differential expression analysis. In this tab you can paste gene identifiers, or upload a file containing them, to build your own list : a gene family, a QTL interval, or a list taken from a publication.

Only the genes found in your normalized expression matrix are kept, and counters show how many were submitted, found, and missing. Once imported, a custom list is usable for clustering, network inference and Venn comparisons, exactly like a differentially expressed gene list.
