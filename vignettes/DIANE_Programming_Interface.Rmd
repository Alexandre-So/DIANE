...
To display the distributions, you can use the argument `type = "density_ridges"`.

```{r vis_raw, fig.width=8, fig.height=5}
DIANE::draw_distributions(abiotic_stresses$raw_counts, type = "boxplot")
```
...
pre_process <- DIANE::draw_distributions(abiotic_stresses$raw_counts, type = "density_ridges") + ggtitle("Before")
post_process <- DIANE::draw_distributions(normalized_counts, type = "density_ridges")+ ggtitle("After")
...
```{r pca_correlation_plot, fig.width=13, fig.height=8}
